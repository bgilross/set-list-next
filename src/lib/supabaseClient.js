...
if (!supabaseUrl || !supabaseAnonKey) {
  if (typeof window !== 'undefined') {
    ...
    console.error('[Supabase] Missing env vars NEXT_PUBLIC_SUPABASE_URL / NEXT_PUBLIC_SUPABASE_ANON_KEY')
  } else {
    console.warn('[Supabase] Environment variables not set; client will be unusable.')
  }
}
...
export function getServiceClient() {
  ...
  if (!serviceKey) throw new Error('Missing SUPABASE_SERVICE_ROLE_KEY (server env)')
